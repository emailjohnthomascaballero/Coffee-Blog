...
function blogauthor_admin_setup()
{

    /**
     * Load and initialize Blogauthor Dashboard Notices
     *
     */
...
add_action('after_setup_theme', 'blogauthor_admin_setup');
