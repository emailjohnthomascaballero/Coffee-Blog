 ...
 * @package Blogauthor
 */
if ( ! function_exists( 'blogauthor_get_default_customizer_values' ) ) :
	/**
	 ...
	 */
	function blogauthor_get_default_customizer_values() {
        ...
        $defaults['about_post_title'] = esc_html__('Behind the Blog', 'blogauthor');
        $defaults['upload_about_image'] = '';

        // header full page add
        $defaults['ed_header_ad'] = false;
        $defaults['ed_header_type'] = 'welcome-banner-default';
        $defaults['advertisement_section_title'] = esc_html__('Welcome Advertisement Message', 'blogauthor');
        ...
        $defaults['shop_post_title'] = __('Shop Now', 'blogauthor');
        ...
        $defaults['shop_post_button_text'] = __('Shop Now', 'blogauthor');
        ...
        $defaults['category_post_title'] = __('Welcome to BlogAuthor', 'blogauthor');
        ...
        $defaults['excerpt_read_more'] = __('[Read More...]', 'blogauthor');
        ...
        $defaults['related_posts_text'] = __('You May Also Like', 'blogauthor');
        ...
        $defaults['author_posts_text'] = __('More From Author', 'blogauthor');
        ...
        $defaults['footer_recommended_post_title'] = esc_html__( 'You May Also Like:', 'blogauthor' );
        ...
        $defaults['copyright_text'] = esc_html__( 'Copyright &copy;', 'blogauthor' );
		...
		$defaults = apply_filters( 'blogauthor_default_customizer_values', $defaults );
		return $defaults;
	}
endif;