...
class Blogauthor_Tab_Posts extends Blogauthor_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'widget_blogauthor_tab_posts';
        $this->widget_description = __("Displays Tab Widget", 'blogauthor');
        $this->widget_id = 'blogauthor_tab_posts';
        $this->widget_name = __('Blogauthor: Tab Posts', 'blogauthor');
        $this->settings = array(
            'popular_heading' => array(
                'label' => esc_html__('Popular', 'blogauthor'),
                'type' => 'heading',
            ),
            'popular_number' => array(
                'label' => esc_html__('No. of Posts:', 'blogauthor'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'default' => 5,
                'min' => 1,
            ...
            'recent_heading' => array(
                'label' => esc_html__('Recent', 'blogauthor'),
                'type' => 'heading',
            ),
            'recent_number' => array(
                'label' => esc_html__('No. of Posts:', 'blogauthor'),
            ...
            'comments_heading' => array(
                'label' => esc_html__('Comments', 'blogauthor'),
                'type' => 'heading',
            ),
            'comments_number' => array(
                'label' => esc_html__('No. of Comments:', 'blogauthor'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'default' => 5,
                'min' => 1,
            ...
            'tagged_heading' => array(
                'label' => esc_html__('Tagged', 'blogauthor'),
                'type' => 'heading',
            ),
            'select_image_size' => array(
                'label' => esc_html__('Select Image Size Featured Post:', 'blogauthor'),
                'type' => 'select',
                'default' => 'medium',
                'options' => array(
                    'thumbnail' => esc_html__('Thumbnail', 'blogauthor'),
                    'medium' => esc_html__('Medium', 'blogauthor'),
                    'large' => esc_html__('Large', 'blogauthor'),
                    'full' => esc_html__('Full', 'blogauthor'),
                ),
            ),
            'style' => array(
                'type' => 'select',
                    ...
                    <li role="presentation" tab-data="tab-popular" class="widget-tab-presentation tab-popular active">
                        <a href="javascript:void(0)" aria-controls="popular" role="tab">
                            <span class="fire-icon tab-icon">
                                <?php blogauthor_theme_svg('blaze'); ?>
                            </span>
                        </a>
                    </li>
