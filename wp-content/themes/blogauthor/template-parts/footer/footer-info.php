...
$enable_copyright = blogauthor_get_option('enable_copyright');
$enable_footer_nav = blogauthor_get_option('enable_footer_nav');
$enable_footer_social_nav = blogauthor_get_option('enable_footer_social_nav');
$enable_footer_credit = blogauthor_get_option('enable_footer_credit');
            ...
            <div class="theme-author-credit">
                ...
                <?php if($enable_copyright):?>
                    <div class="theme-copyright-info">
                        <?php
                        $copyright_text = blogauthor_get_option('copyright_text');
                        if($copyright_text):
                ...
                <?php if($enable_footer_credit): ?>
                    <div class="theme-credit-info">
                        <?php printf(esc_html__('Designed & Developed by %1$s', 'blogauthor'), '<a href="https://themeinwp.com/" target = "_blank" rel="designer">ThemeinWP Team</a>'); ?>
                    </div>
