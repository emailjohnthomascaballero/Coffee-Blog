...
$author_posts_text = blogauthor_get_option('author_posts_text');
$no_of_author_posts = absint(blogauthor_get_option('no_of_author_posts'));
$order = esc_attr(blogauthor_get_option('author_posts_order'));
$orderby = esc_attr(blogauthor_get_option('author_posts_orderby'));
