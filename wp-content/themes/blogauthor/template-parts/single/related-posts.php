...
$related_posts_text = blogauthor_get_option('related_posts_text');
$no_of_related_posts = absint(blogauthor_get_option('no_of_related_posts'));
$order = esc_attr(blogauthor_get_option('related_posts_order'));
$orderby = esc_attr(blogauthor_get_option('related_posts_orderby'));
