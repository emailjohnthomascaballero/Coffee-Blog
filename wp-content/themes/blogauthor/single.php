...
if ($blogauthor_post_layout == "layout-2") { ?>
            ...
            <div class="wrapper">
                ...
                <header class="entry-header">
                    ...
                    if ( 'post' === get_post_type() ) :
                        ?>
                        <div class="blogauthor-entry-meta">
                            <?php
        ...
        <div class="wrapper">
            <div id="primary" class="content-area theme-sticky-component">
                ...
                while (have_posts()) :
                    ...
                    the_post_navigation(
                        array(
                            'prev_text' => '<span class="nav-subtitle">' . esc_html__('Previous:', 'blogauthor') . '</span> <span class="nav-title">%title</span>',
                            'next_text' => '<span class="nav-subtitle">' . esc_html__('Next:', 'blogauthor') . '</span> <span class="nav-title">%title</span>',
                        )
                    );
                    ...
                    if ('post' === get_post_type()) :
                        ...
                        $show_author_info = blogauthor_get_option('show_author_info');
                        $show_related_posts = blogauthor_get_option('show_related_posts');
                        $show_author_posts = blogauthor_get_option('show_author_posts');
...
<?php $show_sticky_article_navigation = blogauthor_get_option('show_sticky_article_navigation');
    ...
    <div class="sticky-article-navigation">
        <?php if( isset( $prev_post->ID ) ){
            ...
            <a class="sticky-article-link sticky-article-prev" href="<?php echo esc_url( $prev_link ); ?>">
                <div class="sticky-article-icon">
                    <?php blogauthor_theme_svg('arrow-left'); ?>
                </div>
        ...
        if( isset( $next_post->ID ) ){
            ...
            <a class="sticky-article-link sticky-article-next" href="<?php echo esc_url( $next_link ); ?>">
                <div class="sticky-article-icon">
                    <?php blogauthor_theme_svg('arrow-right'); ?>
                </div>
                <article id="post-<?php the_ID(); ?>" <?php post_class('theme-article-post theme-sticky-article'); ?>>
                    <?php if (has_post_thumbnail()): ?>
                        <div class="entry-image">
